export default function KnowledgeDeepDiveLoading() {
  return (
    <main className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10 lg:px-0">
      <div className="h-5 w-56 rounded-full bg-white/10 animate-pulse" />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="glass-panel h-60 animate-pulse" />
        <div className="glass-panel h-60 animate-pulse" />
      </div>

...
export function AttitudeHero({ data }: AttitudeHeroProps) {
  ...
  return (
    <section className="glass-panel p-6 grid gap-6 md:grid-cols-[2fr,1fr]">
      <div className="flex flex-col gap-6">
        <div>
          <p className="text-sm uppercase tracking-[0.3em] text-mist/70">Attitude intelligence</p>
...
export { AttitudeHero as AbilitiesHero };
